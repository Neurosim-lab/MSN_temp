...
ek=-94
ena=50
with open('wtd1_params.txt') as f:
	for line in f:
		exec(line)
...
class WTD1:
	...
	def create_cell(self):
		...
		self.distal = [h.Section(name='distal[%d]' % i) for i in xrange(18)]
	...
	def settopo(self):
		#### set L and diam
		self.soma[0].L=11.2753
		self.soma[0].diam=9.99
	...
	def setchannels(self):
		...
		#### set kir params
		for sec in self.all_no_axon:
			sec.qfact_kir=0.2141635752
			sec.mshift_kir=40.7006234696
			sec.mslope_kir=14.9999898586
			sec.gkbar_kir=0.0000753111
		...
		for sec in self.soma:
			# sec.gnabar_naf=0
			sec.gnabar_naf=1.4591637794
			# sec.gnabar_naf=0
			# sec.gnabar_nap=0
			sec.gnabar_nap=0.0002028940
			sec.gkbar_kas=0.0020926321
			sec.gkbar_kaf=0.0400568986
			# sec.gkbar_kas=0
			# sec.gkbar_kaf=0
			sec.gkbar_kdr=0.0022464083
			# sec.gkbar_kdr=0
			sec.gkbar_bkkca=0.0072413401
			sec.gkbar_skkca=0.0447432474
			sec.pbar_caL=0.0000011150
			sec.pcaLbar_caL13=0.0000001622
			sec.pbar_can=0.0000004164
			sec.pcarbar_car=0.0000294557
			sec.pcatbar_cat=0.0000001083
			# sec.gkbar_bkkca=0.
			# sec.gkbar_skkca=0
			# sec.pbar_caL=0
			# sec.pcaLbar_caL13=0
		...
		for sec in self.prox:
			...
			sec.gnabar_naf=1.4591637794*dgnaf_proxF
			# sec.gnabar_naf=0
			# sec.gnabar_nap=0
			sec.gnabar_nap=0.0002028940*dgnap_proxF
			sec.gkbar_kas=0.0020926321
			sec.gkbar_kaf=0.0400568986
			# sec.gkbar_kas=0
			# sec.gkbar_kaf=0
		...
		for sec in self.mid:
			...
			sec.gnabar_naf=1.4591637794*dgnaf_midF
			# sec.gnabar_naf=0
			# sec.gnabar_nap=0
			sec.gnabar_nap=0.0002028940*dgnap_midF
			sec.gkbar_kas=0.0020926321*dgkas_midF
			sec.gkbar_kaf=0.0400568986*dgkaf_midF
			# sec.gkbar_kas=0
			# sec.gkbar_kaf=0
			sec.gkbar_kdr=0.0022464083
			# sec.gkbar_kdr=0
		...
		for sec in self.dist:
			...
			sec.gnabar_naf=1.4591637794*dgnaf_distF
			# sec.gnabar_naf=0
			# sec.gnabar_nap=0
			sec.gnabar_nap=0.0002028940*dgnap_distF
			sec.gkbar_kas=0.0020926321*dgkas_distF
			sec.gkbar_kaf=0.0400568986*dgkaf_distF
			# sec.gkbar_kas=0
			# sec.gkbar_kaf=0
			sec.gkbar_kdr=0.0022464083
			# sec.gkbar_kdr=0
			...
			# sec.pcatbar_cat=0
		#for sec in self.axon:
		#	sec.gnabar_naf=3.6878716587
		#	sec.gkbar_kas=0.0286704164
		#	sec.gkbar_kaf=0.0213947010
		#	sec.gnabar_nap=0.0082428157
		#	sec.gkbar_kdr=0.0050798866
			# sec.gnabar_naf=0
			# sec.gkbar_kas=0
			# sec.gkbar_kaf=0
			# sec.gnabar_nap=0
