...
#set up WTD1 and WTD2 MSN templates
netParams_d1 = specs.NetParams()   # object of class NetParams to store the network parameters
netParams_d1.popParams['D1MSN'] = {'cellModel': 'MSN', 'cellType': 'D1', 'numCells': 10} # add dict with params for this pop 
cellRule_d1=netParams_d1.importCellParams(label='D1MSN', conds={'cellType': 'D1', 'cellModel': 'MSN'}, fileName='d1msn.py', cellName='WTD1')
netParams_d1.cellParams['D1MSN'] = cellRule_d1  
netParams_d2 = specs.NetParams()   # object of class NetParams to store the network parameters
netParams_d2.popParams['D2MSN'] = {'cellModel': 'MSN', 'cellType': 'D2', 'numCells': 10} # add dict with params for this pop 
...
netParams_d1.stimSourceParams['GABA'] = {'type':'NetStim','rate':10,'noise':0.5}
netParams_d1.stimTargetParams['GABA->D1MSN'] = {'source': 'GABA', 'conds': {'cellType': 'D1'}, 'weight': 0.01, 'delay': 5, 'synMech': 'inh'}

netParams_d2.stimSourceParams['AMPA'] = {'type':'NetStim','rate':10,'noise':0.5}
netParams_d2.stimTargetParams['AMPA->D2MSN'] = {'source': 'AMPA', 'conds': {'cellType': 'D2'}, 'weight': 0.01, 'delay': 5, 'synMech': 'exc'}
netParams_d2.stimSourceParams['GABA'] = {'type':'NetStim','rate':10,'noise':0.5}
netParams_d2.stimTargetParams['GABA->D2MSN'] = {'source': 'GABA', 'conds': {'cellType': 'D2'}, 'weight': 0.01, 'delay': 5, 'synMech': 'inh'}
...
# Simulation parameters
simConfig.duration = 2500       # Duration of the simulation, in ms
simConfig.dt = 0.25  
...
sim.createSimulateAnalyze(netParams_d1,pythsimConfig)
